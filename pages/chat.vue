            ...
            <section v-else class="text-center space-y-4 flex flex-col items-center">
                ...
                <div class="p-2 border bg-white border-gray-300 rounded-md shadow-md w-full">
                    <div class="flex w-full">
                        ...
                        <button @click="generateTestLocal" class="flex items-center justify-center btn-primary-full p-2"
                            :disabled="prompt === ''">
                    ...
                    <div class="flex gap-2">
                        <ButtonLevel text="Básico" :selected="level === 'basic'" @click="level = 'basic'" />
